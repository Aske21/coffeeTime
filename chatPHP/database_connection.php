...
$connect = new PDO('mysql:host=' . config::get('mysql/host') . ';dbname=' . config::get('mysql/db'), config::get('mysql/username'), config::get('mysql/password'));
...
function fetch_user_chat_history($from_user_id, $to_user_id, $connect) {
 ...
 $output = '<ul class="list-unstyled" style=" overflow:auto display: flex; flex-direction: column-reverse; overflow=auto;">';
 foreach($result as $row)
 {
  $user_name = '';
